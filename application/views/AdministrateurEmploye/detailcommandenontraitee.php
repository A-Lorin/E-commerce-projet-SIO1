...
.top{margin-top: 5px;}
    ...
    <div class="col">
        ...
        <td>
                ...
                <a href="<?= base_url().'index.php/Visiteur/voirUnProduit/'.$produit->NOPRODUIT?>"><img src="<?= base_url().'assets/images/'.$produit->NOMIMAGE.'.jpg'?>" width="80"/></a>
                <?php } else{?>
                    <a href="<?= base_url().'index.php/Visiteur/voirUnProduit/'.$produit->NOPRODUIT?>"><img src="<?= base_url().'assets/images/nonimage.jpg'?>" width="80"/></a>
                <?php } ?>
            </td>
                <td><a  href="<?= base_url().'index.php/Visiteur/voirUnProduit/'.$produit->NOPRODUIT?>"><?php echo $produit->LIBELLE; ?></a></td>
...
<td colspan='6' class='text-right'><h4>Total: <?php echo $commande->TOTALTTC; ?>€</h4></td></tr>
                ...
                <div class="col-md-3">
                    ...
                    <h3 class="text-center top">Informations sur le client</h3>
                    <table class="table">
                    <tr>
                        <th>Nom:</th>
                    ...
                    <a href="<?php echo site_url('AdministrateurEmploye/passerCommandeATraiter/'.$commande->NOCOMMANDE) ?>" class="btn btn-success btn-lg">Traitée</a>
                    </div>
             </div>
    <div class="col-sm-1">
    </div>
