    ...
    <ol class="carousel-indicators">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item <?php echo $class; ?>">
            <a href="<?= base_url().'index.php/Visiteur/voirUnProduit/'.$vitrine->NOPRODUIT?>">
            <img class="d-block" src="<?= base_url().'assets/images/'.$vitrine->NOMIMAGE.'.jpg'?>" alt="<?= $vitrine->LIBELLE ?>"  >
            </a>
          </div>
          <?php endforeach;?> 
        </div>
...
<h3>Marque:</h3>
<?php foreach ($marques as $marque){ echo '<h4>'.anchor('Visiteur/listerLesProduitsparmarque/'.$marque->NOMARQUE,$marque->NOM). '</h4>'; ?><?php } ?>
<hr/> 
</div>
</div>
