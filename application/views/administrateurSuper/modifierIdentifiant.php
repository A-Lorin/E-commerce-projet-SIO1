...
<?php
  ...
  echo form_open('AdministrateurSuper/modifierIdentifiantSite');

  echo form_label('Site','txtSite','class="text-primary"');
  echo form_input('txtSite', $identifiant->SITE,'class="form-control"');  ?> <br /><?php 

  echo form_label('Rang','txtRang','class="text-primary"');
  ...
  echo form_label('Clé Hmac','txtHmac','class="text-primary"');
  echo form_textarea('txtHmac', $identifiant->CLEHMAC,'class="form-control textareaidentifiant"');    ?> <br /><?php

  echo form_label('Production', 'CheckboxProduction','class="text-primary"');?><br/>
