            ...
            <table class="table">
                ...
                <?php if($this->cart->total_items() > 0){foreach ($this->cart->contents() as $items): ?>
                        ...
                        <td>
                            ...
                            <img src="<?= base_url().'assets/images/'.$items['image'].'.jpg'?>" width="80"/>
                            <?php } else{?>
                        ...
                        <td><?php echo $this->cart->format_number($items['subtotal']); ?>€</td></tr>


                <?php endforeach; }?>
                        <tr>
                            <td><a href="<?php echo site_url('visiteur/afficherPanier'); ?>" class="btn btn-warning">Modifier la commande</a></td>
                            <td colspan="2"></td>
                            <?php if($this->cart->total_items() > 0){ ?>
                            <td>Total: <b><?php echo $this->cart->total().' €'; ?></b></td>
                            <?php if (!empty($this->session->statut)){?>
                            <td><form method = "POST" action="<?php echo $serveurOK; ?>">
                ...
                <div class="border border-secondary">
                    ...
                    <tr>
                        <td class="text-center" colspan="2"><a class="btn btn-info text-center" href="<?php echo site_url('Client/modifierSonCompte') ?>">Modifier</a></td>
                    </tr>
                    </table>
                    </div>
        </div>
