...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 21 jan. 2021 à 20:26
...
('admin', 'admin@sfr.fr', 'Super', '$2y$10$D3LDcdeXq0g1ZtOPGxw5xuPjvTt06KTIcvRe52d4V.sHYR7pLBXeC'),
('test', 'test@yopmail.com', 'Employé', '$2y$10$XuItfo2iRludTzZXGzrGOuwBciLLFUg44sDZvm.zZyC9WULI4okYq');
...
CREATE TABLE IF NOT EXISTS `avis` (
  `NOAVIS` int(5) NOT NULL AUTO_INCREMENT,
  `NOCLIENT` int(2) NOT NULL,
  `NOPRODUIT` int(2) NOT NULL,
  `AVIS` int(2) NOT NULL,
  `TITRECOMMENTAIRE` varchar(250) DEFAULT NULL,
  `COMMENTAIRE` varchar(250) DEFAULT NULL,
  `DATEAVIS` date NOT NULL,
  `MODIFIER` int(1) DEFAULT NULL,
  PRIMARY KEY (`NOAVIS`),
  KEY `I_FK_AVIS_NOCLIENT` (`NOCLIENT`),
  KEY `I_FK_AVIS_NOPRODUIT` (`NOPRODUIT`)
...
(1, 'Sarkozy', 'Nicolas', '4 rue des hirondelles sur mer', 'SAINT-BRIEUC', 29145, 'test@sfr.fr', '$2y$10$8.G6xxKHvMuG6H1ZNL30heY2f7rvVBcKtot2Wf1DA1xnr6kWWGV.u'),
(2, 'Hollande', 'François', 'test', 'TEST', 12345, 'test1@yopmail.com', '$2y$10$SaxviojEgzcsjC3u0YbNVeTJNQlMZu8Uqso1ZHRpu7kyV4m5j.X6i'),
(4, 'Macron', 'Emmanuel', 'test', 'TEST', 12345, 'test@yopmail.com', '$2y$10$v87QjkumcyXaLnGYAG4WoOnsWWIDU354smp1T8sZMXXE1H9ZNblXu'),
(5, 'Chirac', 'Jacques', 'a', 'A', 12345, 'a@yopmail.com', '$2y$10$QqpqOUrrX/FTwG84riIDDu8JHjQycchU4VaBWOEjuMSx38tWEFWrm'),
(7, 'Mitterand', 'François', 'azerty', 'AZERTY', 12345, 'azerty@sfr.fr', '$2y$10$oQBZDMtHh5LKipmxEaTZoe5TpSYYMqGRjyJwUq8NETTOjNnWPjzk.'),
(8, 'Giscard d\'Estaing', 'Valéry', 'azerty', 'AZERTY', 12345, 'azerty1@sfr.fr', '$2y$10$p1x89Ga3JASNppH.0ze/iemImigm0MQkCjmE3BfNzm7zoe.nwoIFW'),
(9, 'Pompidou', 'Georges', 'azerty', 'AZERTY', 12345, 'azerty2@sfr.fr', '$2y$10$h8G4bGimV0daNBm00cnZluYk4LXTxHqUjkDQXJFIGf0HKZul1DwlC'),
(10, 'De Gaulle', 'Charles', 'azertytest', 'AZERTYTEST', 12345, 'azertytest@sfr.fr', '$2y$10$FUzD7tblTMlOfHDw2p4bdu7rVDh8gCQVRNmRgQr.P8jJnA1pwhy5W'),
(11, 'Fillion', 'François', 'qwerty', 'QWERTY', 12345, 'qwerty@sfr.fr', '*AA1420F182E88B9E5F874F6FBE7459291E8F4601');
...
(69, 1, '2020-07-03 05:58:03', '62.71', '75.25', NULL),
(70, 1, '2020-07-03 06:37:04', '16.63', '19.96', '2020-07-03 15:19:27'),
(71, 5, '2020-07-05 02:35:12', '28.72', '34.46', NULL),
(72, 7, '2020-09-01 02:06:05', '19.00', '22.80', NULL),
(73, 4, '2021-01-15 02:24:42', '14.99', '17.99', '2021-01-15 02:26:47');
...
--
ALTER TABLE `avis`
  ADD CONSTRAINT `FK_AVIS_NOCLIENT` FOREIGN KEY (`NOCLIENT`) REFERENCES `client` (`NOCLIENT`),
  ADD CONSTRAINT `FK_AVIS_NOPRODUIT` FOREIGN KEY (`NOPRODUIT`) REFERENCES `produit` (`NOPRODUIT`);
